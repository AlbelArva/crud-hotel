...
<html>
  <head>
    ...
    <style>
      body {
            background-image: url('image/background_kamar.jpg');
    ...
    */
    ...
    $sql = "SELECT tamu.id, tamu.nama, tamu.jns_kel, tamu.notelp, tamu.jalan, tamu.kota, tamu.provinsi, tamu.kd_pos, tamu.keterangan, kamar.no_kamar FROM tamu JOIN kamar ON tamu.id = kamar.id ORDER BY id ASC";
