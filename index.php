...
<html>
  <head>
    ...
    <style>
        body {
            background-image: url('image/resepsionis.jfif');
            ...
            <form id="form_input" action="index.php" method="post">
              ...
              include 'koneksi.php';
               if(isset($_POST['simpan'])){
                 ...
                 $input = "INSERT INTO tamu (id, nama, jns_kel, notelp, jalan, kota, provinsi, kd_pos, keterangan, tgl_checkin, tgl_checkout) VALUES ('$id', '$nama', '$jns_kel', '$notelp', '$jalan', '$kota', '$provinsi', '$kd_pos', '$keterangan', '$tgl_checkin', '$tgl_checkout')";
